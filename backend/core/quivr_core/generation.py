...
async def get_group_list(community_id: str):
    """get all the groups in the current community
...
async def create_channel(name: str, community_id: str, emoji: str):
    """creates a new channel in the current community. *Call this only, if user clearly states to create a new channel*.
...
async def create_group(name: str, community_id: str, emoji: str):
    """creates a new group in the current community. *Call this only, if user clearly states to create a new group*.
